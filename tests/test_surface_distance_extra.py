...
def test_plane_parallel_no_intersection():
    plane = yamc.XPlane(x0=1.0, surface_id=1)
...
def test_sphere_inside_out():
    sphere = yamc.Sphere(x0=0.0, y0=0.0, z0=0.0, r=2.0, surface_id=1)
...
def test_cylinder_axis_parallel():
    cyl = yamc.ZCylinder(x0=0.0, y0=0.0, r=1.0, surface_id=1)
...
def test_plane_negative_direction():
    plane = yamc.XPlane(x0=2.0, surface_id=1)
